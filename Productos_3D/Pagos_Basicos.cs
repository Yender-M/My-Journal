...
{
    public partial class Pagos_Basicos : Form
    {
        ...
        private void lblBuscar_ofrenda_Click(object sender, EventArgs e)
        {
        ...
        {
            string buscarPorid;
            string dato = txtBuscar_PagosBasicos.Text;
            if (dato == "")
            {
            ...
            dgvVerPagosBasicos.DataSource = bd.SelectDataTable(buscarPorid);
        }
