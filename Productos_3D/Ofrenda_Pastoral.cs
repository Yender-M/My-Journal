...
{
    public partial class Ofrenda_Pastoral: Form
    {
        ...
        {
            string buscarPorid;
            string dato = txtBuscar_OfrendaPastoral.Text;
            if (dato == "")
            {
            ...
            dgvVerOfrendaPastoral.DataSource = bd.SelectDataTable(buscarPorid);
        }
