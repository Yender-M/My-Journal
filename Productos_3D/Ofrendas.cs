...
{
    public partial class Ofrendas : Form
    {
        ...
        public Ofrendas()
        {
            ...
            dgvVerOfrenda.DataSource = bd.SelectDataTable("select nombre_producto Nombre, nombre_categoria Categoria, nombre_material Material, costo_luz Luz, peso_producto Peso, total Precio from productos A inner join categoria B on A.id_categoria = B.id_categoria inner join material C on A.id_material = C.id_material; ");
        ...
        {
            string buscarPorid;
            string dato = txtBuscar_ofrenda.Text;
            if (dato == "")
            {
            ...
            dgvVerOfrenda.DataSource = bd.SelectDataTable(buscarPorid);
        }
