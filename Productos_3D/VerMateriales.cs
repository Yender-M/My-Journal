...
namespace My_Journal
{
    public partial class VerMateriales : Form
    {
        bool agregar = false;
        string estado = "s";
        float precio_gramo = 0, precioMaterial = 0, existencia = 0;
        ...
        private async void btnActualizarMaterial_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string Cadena = "UPDATE material SET nombre_material = '" + txtbVerNomMaterial.Text + "', marca = '"+ txtbVerMarcaMaterial.Text+"', precio_gramo = " +precio_gramo+ ", precio_material = "+ precioMaterial+", existencia = "+existencia+", estado = '"+estado+"'  where nombre_material = '" + nombreValidarMaterial + "';";
        ...
        private void dgvVerMateriales_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            existencia = float.Parse(this.txtbVerExistenciaMaterial.Text);
        ...
        private void Buscar_TextChanged(object sender, EventArgs e)
        {
            ...
            if (dato == "")
            {
                buscarPorid = "select nombre_material Nombre, marca Marca, precio_material Precio_kg, existencia Existencia, estado Estado  from Material ORDER BY id_material ASC";
