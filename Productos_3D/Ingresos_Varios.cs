...
{
    public partial class Ingresos_Varios: Form
    {
        ...
        {
            string buscarPorid;
            string dato = txtBuscar_ingreVarios.Text;
            if (dato == "")
            {
            ...
            dgvVerIngresosVarios.DataSource = bd.SelectDataTable(buscarPorid);
        }
